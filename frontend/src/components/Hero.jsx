...
const Hero = () => {
  return (
    <section className="relative bg-hero bg-cover bg-center bg-norepeat h-screen w-full">
      <div className="max_padd_container relative top-32 xs:top-52">
        <h1 className="h1 capitalize max-w-[37rem]">
          Digital Shoping Hub Junction
        </h1>
        <p className="text-gray-50 regular-16 mt-6 max-w-[33rem]">
          Lorem ipsum dolor sit amet, qui minim labore adipisicing minim Lorem
          ipsum dolor sit amet, qui minim labore adipisicing minim sint cillum
          sint consectetur cupidatat. sintkcillum sint consectetur cupidatat
        </p>
